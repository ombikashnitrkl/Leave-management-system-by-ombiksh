...
<div class="row-fluid">
    <div class="span3"><strong><?php echo lang('users_myprofile_field_bloodgroup');?></strong></div>
    <div class="span3"><?php echo $user['bloodgroup'];?></div>
    <div class="span6">&nbsp;</div>
</div>
...
<div class="row-fluid">
    <div class="span3"><strong><?php echo lang('users_myprofile_field_previousemployer');?></strong></div>
    <div class="span3"><?php echo $user['previousemployer'];?></div>
    <div class="span6">&nbsp;</div>
</div>

<div class="row-fluid">
    <div class="span3"><strong><?php echo lang('users_myprofile_field_reasonforleaving');?></strong></div>
    <div class="span3"><?php echo $user['reasonforleaving'];?></div>
    <div class="span6">&nbsp;</div>
</div>

<div class="row-fluid">
    <div class="span3"><strong><?php echo lang('users_myprofile_field_briefdescriptionofrole');?></strong></div>
    <div class="span3"><?php echo $user['briefdescriptionofrole'];?></div>
    <div class="span6">&nbsp;</div>
</div>
<div class="row-fluid">
     <div class="span3"><strong> <?php echo lang('users_myprofile_field_address');?></strong> </div>
	 <div class="span3"><?php echo $user['address'];?></div>
</div>
