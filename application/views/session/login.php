...
$languages = $this->polyglot->nativelanguages($this->config->item('languages'));?>
    ...
    <button id="cmdGoogleSignIn" class="btn btn-danger social-but"><i class="fa fa-google"></i>&nbsp;<?php echo lang('session_login_button_login_google');?></button>
    <button id="cmdFacebookSignIn" class="btn btn-primary social-but"><i class="fa fa-facebook"></i>&nbsp;<?php echo lang('session_login_button_login_facebook');?></button>  
    <br /><br />
